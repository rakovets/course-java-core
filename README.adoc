...
|Decision-making statements.|link:src/main/java/com/rakovets/course/java/core/practice/statements/decisionmaking[package: decisionmaking]
|Looping statements.|link:src/main/java/com/rakovets/course/java/core/practice/statements/looping[package: looping]
