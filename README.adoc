...
|Decision-making statements.|link:src/main/java/com/rakovets/course/java/core/practice/statements/decisionmaking[package: statements-decision-making]
|Looping statements.|link:src/main/java/com/rakovets/course/java/core/practice/statements/looping[package: statements-looping]
|Arrays.|link:src/main/java/com/rakovets/course/java/core/practice/array[package: arrays]
