...
public class Task07 {
    public static void main(String[] args) {
        ...
        double needDistance = startDistance, trainingDistance = startDistance;
        while (trainingDistance < finishDistance) {
            trainingDistance += trainingDistance * dailyProgress / 100.0;
            needDistance += trainingDistance;
            if (startDistance == 0) {
                break;
            }
        }
        System.out.printf(Locale.ENGLISH, "%.2f", ((needDistance - trainingDistance) * 100.0) / 100.0);
    }
}