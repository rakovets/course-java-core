...
public class Task08 {
    public static void main(String[] args) {
        ...
        double dif = (numberItems + differentialNumberItems) / (double) numberItems;
        double addPrice = startPriceAllItems * dif - startPriceAllItems;
        double cost = startPriceAllItems;
        System.out.print(numberItems + " - " + cost);
        for (int i = 1; i < sizeTotalPrice; i++) {
            cost += addPrice;
            numberItems = startNumberItems + i * differentialNumberItems;
            System.out.print("\n" + numberItems + " - " + cost);
        }
    }
}