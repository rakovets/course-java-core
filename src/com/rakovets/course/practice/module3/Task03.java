...
public class Task03 {
    public static void main(String[] args) {
        ...
        if (healthPointPercentage>=0 && healthPointPercentage<=24){
            System.out.println("RED");
        }else if (healthPointPercentage>=25 && healthPointPercentage<=49){
            System.out.println("ORANGE");
        }else if (healthPointPercentage>=50 && healthPointPercentage<=74){
