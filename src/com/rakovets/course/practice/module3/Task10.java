    ...
    public static void main(String[] args) {
        ...
        if (firstFuelReserves < secondFuelReserves & firstFuelReserves < thirdFuelReserves)
        {
            ...
            System.out.println("3");
                 ...
                 if (firstFuelReserves < thirdFuelReserves & secondFuelReserves < thirdFuelReserves)
            {
            System.out.println("1 2");
        } else
                 if (firstFuelReserves < secondFuelReserves & thirdFuelReserves < secondFuelReserves)
            {
            System.out.println("1 3");
        } else
                 if (secondFuelReserves < firstFuelReserves & thirdFuelReserves < firstFuelReserves)
            {
