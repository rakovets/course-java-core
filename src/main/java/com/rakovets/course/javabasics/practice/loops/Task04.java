...
public class Task04 {
    public static void main(String[] args) {
        ...
        double healthPointsIncreased = healthPoints;
        //TODO
        // Код, решающий задачу пишем ниже, при этом используяся переменные объявленные выше (их можно изменять)
        // Для проверки решения необходимо запустить @Test для данного class (в директории test)
        for (int i = 1; i <= hoursAfterRespawn; i++) {
            double resultHpPerHour = healthPointsIncreased * regenerationPercentFromCurrentHealth / 100.0;
            healthPointsIncreased = healthPointsIncreased + resultHpPerHour;
        }
        int result = (int) healthPointsIncreased;
