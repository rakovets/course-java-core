...
public class Task6 {
    public void getNumber(int number) throws ArgumentNegativeException, ArgumentZeroException, ArgumentPositiveException {
        if (number > 0) {
            throw new ArgumentPositiveException("It's positive number");
        } else if (number == 0) {
            throw new ArgumentZeroException("It's zero");
        } else {
            throw new ArgumentNegativeException("It's negative");
        }
    }
}
