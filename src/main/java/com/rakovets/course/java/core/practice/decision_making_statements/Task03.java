...
class Task03 {
    ...
    static String getColorHealthPoint(int currentHealthPoint, int maxHealthPoint) {
        ...
        String hpColor;
        float percentRatio = 1.0f * currentHealthPoint * 100 / maxHealthPoint;
        if (percentRatio > 0 && percentRatio < 25) {
            hpColor = "RED";
        } else if (percentRatio >= 25 && percentRatio < 50 ) {
            hpColor = "ORANGE";
        } else if (percentRatio >= 50 && percentRatio < 75) {
            hpColor = "YELLOW";
        } else if (percentRatio >= 75 && percentRatio <= 100) {
            hpColor = "GREEN";
        } else {
            return null;
        }
