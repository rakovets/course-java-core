...
class Task03 {
    ...
    static int calculateHealthPointsByTime(int healthPoints, double regenerationPercentFromCurrentHealth, int hoursAfterRespawn) {
        ...
        double healthPointAfterRespawn = healthPoints;
        for (int i = 0; i < hoursAfterRespawn; i++) {
            healthPointAfterRespawn += healthPointAfterRespawn / 100 * regenerationPercentFromCurrentHealth;
        }
        return (int)(healthPointAfterRespawn);
    }
}
