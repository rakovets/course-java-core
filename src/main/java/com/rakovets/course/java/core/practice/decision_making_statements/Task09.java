...
class Task09 {
    ...
    static int getPorchNumber(int numberFloors, int numberApartmentsPerFloor, int apartmentNumber) {
        ...
        int apartmentsInPorch = numberFloors * numberApartmentsPerFloor;
        return apartmentNumber % apartmentsInPorch > 0
                ? apartmentNumber / apartmentsInPorch + 1
                : apartmentNumber / apartmentsInPorch;
    }
}
