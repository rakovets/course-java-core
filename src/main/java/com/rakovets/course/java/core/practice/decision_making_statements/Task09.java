...
class Task09 {
    ...
    static int getPorchNumber(int numberFloors, int numberApartmentsPerFloor, int apartmentNumber) {
        int _porchNumber = (apartmentNumber % (numberApartmentsPerFloor * numberFloors) > 0)
                         ? apartmentNumber / (numberApartmentsPerFloor * numberFloors) + 1
                         : apartmentNumber / (numberApartmentsPerFloor * numberFloors);
        return _porchNumber;
    }
}
