...
class Task09 {
    ...
    static int getPorchNumber(int numberFloors, int numberApartmentsPerFloor, int apartmentNumber) {
        ...
        int result;
        int apartmentsCount = numberFloors * numberApartmentsPerFloor;
        if (apartmentNumber / apartmentsCount >= 0 && apartmentNumber % apartmentsCount != 0) {
            result = (apartmentNumber / apartmentsCount) + 1;
        } else {
            result = apartmentNumber / apartmentsCount;
        }
        return result;
    }
}
