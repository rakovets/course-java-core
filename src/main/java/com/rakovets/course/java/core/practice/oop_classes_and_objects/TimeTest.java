...
public class TimeTest {
    public static void main(String[] args) {
        ...
        System.out.printf("Current time for testTime1 is %s hours, %s minutes, %s seconds and total seconds are %s.%n",
                testTime1.getHours(), testTime1.getMinutes(), testTime1.getSeconds(), testTime1.getTotalSeconds());
        System.out.printf("Current time for testTime2 is %s hours, %s minutes, %s seconds and total seconds are %s.%n",
