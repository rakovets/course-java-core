...
class Task06 {
    ...
    static String getPlayingTime(int playingTimeInSeconds) {
        ...
        int h = (playingTimeInSeconds % SEC_IN_DAY) / SEC_IN_HOUR;
        int m = (playingTimeInSeconds % SEC_IN_DAY % SEC_IN_HOUR) / MIN_IN_HOUR;
        int s = (playingTimeInSeconds % SEC_IN_DAY % SEC_IN_HOUR) % MIN_IN_HOUR;
        return d + " " + h + ":" + m + ":" + s;
    }
}
