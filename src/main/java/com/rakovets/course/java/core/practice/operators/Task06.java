...
class Task06 {
    ...
    static String getPlayingTime(int playingTimeInSeconds) {
        ...
        int minutes = playingTimeInSeconds % SECONDS_TO_DAYS % SECONDS_TO_HOURS / SECONDS_TO_MINUTES;
        int seconds = playingTimeInSeconds % SECONDS_TO_DAYS % SECONDS_TO_HOURS % SECONDS_IN_MINUTE;
