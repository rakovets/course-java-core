...
class Task06 {
    ...
    public static void main(String[] args) {
        ...
        int tanksKilledFirstPlayer = 12;
        int tanksKilledSecondPlayer = 18;
    ...
    static String getResult(int tanksKilledFirstPlayer, int tanksKilledSecondPlayer) {
        if (tanksKilledFirstPlayer > tanksKilledSecondPlayer) {
            return "Player 1: " + ((tanksKilledFirstPlayer * KILL_POINT) + BONUS_POINT) +
                    ". Player 2: " + (tanksKilledSecondPlayer * KILL_POINT);
        } else if (tanksKilledFirstPlayer < tanksKilledSecondPlayer) {
            return "Player 1: " + (tanksKilledFirstPlayer * KILL_POINT) +
                    ". Player 2: " + ((tanksKilledSecondPlayer * KILL_POINT) + BONUS_POINT);
        } else {
            return "Player 1: " + (tanksKilledFirstPlayer * KILL_POINT) +
                    ". Player 2: " + (tanksKilledSecondPlayer * KILL_POINT);
        }
