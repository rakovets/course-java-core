...
public class Task07 {
    ...
    public void printArray(int sizeOfArray, int startToPrintArray, int endToPrintArray, final int MAXIMUM_SIZE_OF_ARRAY) throws MyExeptionTask07{
    ...
    public void printArray2(int sizeOfArray, int startToPrintArray, int endToPrintArray) {
        int[] array = new int[sizeOfArray];
        for (int i = startToPrintArray - 1; i < endToPrintArray; i++) {
            array[i] += i + 1;
            System.out.print(array[i] + " ");
