...
public class FileAnalyzeUtilTest {
    ...
    void getList() {
        ...
        // WHEN
        List<String> actualList = FileAnalyzeUtil.getList("src/main/resources/Test.txt");
    ...
    void getListStartsWithVowels() {
        ...
        // WHEN
        List<String> actualList = FileAnalyzeUtil.getListStartsWithVowels("src/main/resources/Test.txt");
    ...
    void getListLastLetterEqualsFirstLetter() {
        ...
        // WHEN
        List<String> actualList = FileAnalyzeUtil.getListLastLetterEqualsFirstLetter("src/main/resources/Test.txt");
    ...
    void getLongestAscendingCombination() {
        ...
        // WHEN
        List<String> actualList = FileAnalyzeUtil.getLongestAscendingCombination("src/main/resources/TestNumbers.txt");
    ...
    void getLettersFrequency() {
        ...
        // WHEN
        String actualString = FileAnalyzeUtil.getLettersFrequency("src/main/resources/Test.txt").toString();
    ...
    void getAscendingWordFrequency() {
        ...
        // WHEN
        String actualString = FileAnalyzeUtil.getAscendingWordFrequency("src/main/resources/Test.txt").toString();
    ...
    void sortAndWriteNumbers() {
        ...
        // WHEN
        boolean actualBoolean = FileAnalyzeUtil.sortAndWriteNumbers("src/main/resources/TestNumbers.txt");
    ...
    void getStudentAverageMark() {
        ...
        Collections.addAll(expectedList, "Wilson - average mark: 6,50",
            ...
            // WHEN
        List<String> actualList = FileAnalyzeUtil.getStudentAverageMark("src/main/resources/Students.txt");
