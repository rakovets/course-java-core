...
public class MyFavoriteSeasonInfoTest {
    static private MyFavoriteSeasonInfo myFavoriteSeasonInfo;
    private String result;
    private String expected;

    @BeforeAll
    static void initAll() {
        myFavoriteSeasonInfo = new MyFavoriteSeasonInfo(Seasons.SPRING);
    }
    ...
    void printFavoriteSeasonInfoTest() {
        result = myFavoriteSeasonInfo.favoriteSeasonInfo();
    ...
    void printFavoriteSeasonTest() {
        result = myFavoriteSeasonInfo.printFavoriteSeason(myFavoriteSeasonInfo.getFAVORITE_SEASON());
