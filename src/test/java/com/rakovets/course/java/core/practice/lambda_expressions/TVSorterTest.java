...
import com.rakovets.course.java.core.practice.lambda_expressions.TV.TVSorter;
...
public class TVSorterTest {
    ...
    void getWithDiagonal() {
        ...
        // WHEN
        List<TV> actualList = TVSorter.getWithDiagonal(items, 55.5);
    ...
    void getOfProducer() {
        ...
        // WHEN
        List<TV> actualList = TVSorter.getOfProducer(items, "LG");
    ...
    void getAfterProductionYear() {
        ...
        // WHEN
        List<TV> actualList = TVSorter.getAfterProductionYear(items, 2020);
    ...
    void getPriceBetween() {
        ...
        // WHEN
        List<TV> actualList = TVSorter.getPriceBetween(items, 300.0, 500.0);
    ...
    void getAscendingPrice() {
        ...
        // WHEN
        List<TV> actualList = TVSorter.getAscendingPrice(items);
    ...
    void getDescendingPrice() {
        ...
        // WHEN
        List<TV> actualList = TVSorter.getDescendingPrice(items);
    ...
    void getAscendingDiagonal() {
        ...
        // WHEN
        List<TV> actualList = TVSorter.getAscendingDiagonal(items);
    ...
    void getDescendingDiagonal() {
        ...
        // WHEN
        List<TV> actualList = TVSorter.getDescendingDiagonal(items);
