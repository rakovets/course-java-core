...
public class StudioDemo {
    public static void main(String[] args) {
        ...
        for (Actor actor : actorsList) {
            System.out.println("Sort by fee: " + actor.getFee() + " " + actor.getLastName());
        }

        Collections.sort(actorsList, new ageComparator());
        for (Actor actor : actorsList) {
            System.out.println("Sort by age: " + actor.getAge() + " " + actor.getLastName());
        }

        Collections.sort(actorsList, new lastNameComparator());
        for (Actor actor : actorsList) {
            System.out.println("Sort by lastname: " + actor.getLastName());
        }
        ...
        for (Actor actor : actorsList) {
            System.out.println("Sort by lastname and age: " + actor.getLastName() + " " + actor.getAge());
        }
        ...
        for (Actor actor : actorsList) {
            System.out.println("Sort by lastname and fee: " + actor.getFee() + " " + actor.getLastName());
        }

        Studio.fire(actorsList);
        for (Actor actor : actorsList) {
            System.out.println(actor.getLastName() + " is not fired yet");
        }
    }
}
