...
public class AtmTest {
    ...
    void testAddBanknotes20(int numberBanknotes20, int numberBanknotes50, int numberBanknotes100,
                            int number, int expected20) {
    ...
    void testAddBanknotes100(int numberBanknotes20, int numberBanknotes50, int numberBanknotes100,
                             int number, int expected100) {
        Atm atm = new Atm(numberBanknotes20, numberBanknotes50, numberBanknotes100);
